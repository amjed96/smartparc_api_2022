...
class DemandeIntervention(models.Model):
    ...
    vehicule = models.ForeignKey('flotte.Vehicule', null=True, on_delete=models.SET_NULL, related_name='demande_vehicule', blank=True)
...
class Intervention(models.Model):
    ...
    vehicule = models.ForeignKey('flotte.Vehicule', null=True, on_delete=models.SET_NULL, related_name='intervention_vehicule', blank=True)
...
class PlanEntretien(models.Model):
    ...
    vehicule = models.ForeignKey('flotte.Vehicule', null=True, on_delete=models.SET_NULL, related_name='plan_vehicule', blank=True)
    type = models.CharField(max_length=25, null=True, blank=True)
