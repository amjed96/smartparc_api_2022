...
class DemandeInterventionGarage(models.Model):
    ...
    vehicule = models.ForeignKey('flotte.Vehicule', null=True, on_delete=models.SET_NULL, related_name='demande_vehicule_garage')
...
class InterventionGarage(models.Model):
    ...
    vehicule = models.ForeignKey('flotte.Vehicule', null=True, on_delete=models.SET_NULL, related_name='intervention_vehicule_garage')
...
class PlanEntretienGarage(models.Model):
    ...
    vehicule = models.ForeignKey('flotte.Vehicule', null=True, on_delete=models.SET_NULL, related_name='plan_vehicule_garage')
    type = models.CharField(max_length=25, null=True)
